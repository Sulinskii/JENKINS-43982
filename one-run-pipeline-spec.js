...
describe("view/one-run-pipeline", function () {
    ...
    function testStageViewLayout(feature, done, devMode) {
        helper.testWithJQuery(controllerHtml, function ($) {
            ...
            var expectedFrag = helper.requireTestRes('view/one-run-pipeline/render/' + feature + '.html');
